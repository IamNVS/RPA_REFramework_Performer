using RoboticEnterpriseFramework_Performer_Final_Project.ObjectRepository;
using System;
...
namespace RoboticEnterpriseFramework_Performer_Final_Project.Tests
{
    public class CodedTestCase_Work_Item_Details : CodedWorkflow
    {
        [TestCase]
        public void Execute()
        {
            // Arrange
            Log("Test run started for CodedTestCase_Work_Item_Details.");
